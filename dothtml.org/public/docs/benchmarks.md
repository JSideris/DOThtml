...
| :--- | :--- | :--- | :--- | :--- |
| **Create 1,000 rows** | 7.05 ms | 7.40 ms | 6.77 ms | **5.91 ms** |
| **Create 10,000 rows** | 675.10 ms | 662.30 ms | 508.20 ms | **458.10 ms** |
| **Append 1,000 rows** | **7.26 ms** | 72.78 ms | 51.65 ms | 49.94 ms |
| **Update every 10th row** | **0.14 ms** | **0.14 ms** | **0.14 ms** | **0.14 ms** |
| **Swap Rows** | **0.14 ms** | **0.14 ms** | **0.14 ms** | **0.14 ms** |
| **Clear** | 1.45 ms | 1.44 ms | **1.43 ms** | 1.44 ms |
| **Bulk Style Update** | **0.15 ms** | 0.40 ms | 0.25 ms | 0.21 ms |
| **First Contentful Paint** | 28.00 ms | 28.00 ms | 28.00 ms | 28.00 ms |
| **DOM Interactive** | 5.20 ms | 5.30 ms | 4.90 ms | 5.10 ms |
| **Framework Ready** | 18.80 ms | 8.20 ms | 7.90 ms | **5.80 ms** |
...
| **Bundle & Runtime** | **21.4 kB Runtime**. A fixed-size engine that manages all components and reactivity. | **~2 kB (Compiled)**. Minimal initial overhead, though code grows with component count. | **~42 kB Runtime**. A robust engine supporting a vast ecosystem and complex state. | **~33 kB Runtime**. A feature-rich engine balancing power and footprint. |
